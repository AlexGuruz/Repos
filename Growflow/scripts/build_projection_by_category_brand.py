...
def unique_order_lines_in_local_window(
    ...
    """Return in-window order lines once, preserving ``seen`` across API chunks."""
...
def main() -> int:
    ...
    for from_iso, to_iso in iter_sold_at_date_chunks(window_start, window_end, args.chunk_days):
        ...
        for n, ld in unique_order_lines_in_local_window(
