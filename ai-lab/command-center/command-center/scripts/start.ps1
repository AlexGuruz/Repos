...
# Usage: .\start.ps1          use existing .env, or create from env.minimal if missing
...
Write-Host ""
Write-Host "  Close the two spawned PowerShell windows to stop" -ForegroundColor DarkGray
