...
- **This repo** is the governance layer. Main rig and worker rig use the same clone (e.g. `E:\AI\ai-lab-governance\` or `E:\Repos\ai-lab-governance\` on main; `/opt/ai/ai-lab-governance/` on worker).
