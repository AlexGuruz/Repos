...
def _post_meta_key(source_sid: str, source_tab: str, row0: int, target_a1: str) -> Tuple[str, str, int, str]:
    return (str(source_sid or ""), str(source_tab or ""), int(row0), str(target_a1))
    ...
    def _process_target(target_sid: str, txns_for_target: List[dict], ignore_posted: bool = False) -> Dict[str, object]:
        ...
        for (
            ...
            if for_marking:
                ...
                if is_txn_flagged and instance_id:
                    try:
                        flagged = is_txn_flagged(
                            ...
                            posted_date=str(posted_date_raw or ""),
                ...
                post_meta_by_source[_post_meta_key(source_sid, src_tab, row0, a1)] = {
                    "txn_uid": txn_uid,
