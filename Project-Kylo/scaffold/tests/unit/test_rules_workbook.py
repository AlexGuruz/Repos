...
def test_rules_workbook_accepts_nested_dict_config(monkeypatch) -> None:
    monkeypatch.delenv("KYLO_RULES_MANAGEMENT_SPREADSHEET_ID", raising=False)
    cfg = {"rules": {"management_spreadsheet_id": "1nestedSpreadsheetId_234567890"}}

    assert get_rules_management_spreadsheet_id(cfg) == "1nestedSpreadsheetId_234567890"
