...
def main():
    """Main test function"""
    print("🚀 Kylo Transaction Trace Test (Simple)")
    print("="*60)
    ...
    # Configuration
    db_url = os.environ.get('DATABASE_URL', 'postgresql://postgres:kylo@localhost:5432/kylo_global')
