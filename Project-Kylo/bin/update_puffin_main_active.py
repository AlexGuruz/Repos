...
def update_puffin_main_active():
    """Update PUFFIN PURE's active tab in the main workbook with promoted rules"""
    spreadsheet_id = "1mdLWjezU5uj7R3Rp8bTo5AGPuA4yY81bQux4aAV3kec"
    company_id = "PUFFIN PURE"
    ...
    result = subprocess.run([
        "docker", "exec", "-i", "kylo-pg", "psql", "-U", "postgres", "-d", "kylo_puffin", 
