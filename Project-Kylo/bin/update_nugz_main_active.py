...
def update_nugz_main_active():
    """Update NUGZ's active tab in the main workbook with promoted rules"""
    ...
    # Get rules from database via container
    import subprocess
    result = subprocess.run([
        "docker", "exec", "-i", "kylo-pg", "psql", "-U", "postgres", "-d", "kylo_nugz", 
        "-c", "SELECT rule_json FROM app.rules_active ORDER BY applied_at;", "-t"
