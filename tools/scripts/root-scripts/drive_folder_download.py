...
# tools/scripts/root-scripts -> repos root
REPOS_ROOT = os.path.normpath(os.path.join(SCRIPT_DIR, "..", "..", ".."))
STASHBOX_CREDENTIALS = os.path.join(
    REPOS_ROOT, "products", "project-kylo", ".secrets", "service_account.json"
)
...
def main():
    ...
    if not os.path.isfile(creds_path):
        ...
        print("Set GOOGLE_APPLICATION_CREDENTIALS or ensure products/project-kylo/.secrets/service_account.json exists.")
        sys.exit(1)
